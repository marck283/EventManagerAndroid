...
public class ReviewsViewModel extends ViewModel {
    public void getReviews(@NonNull ReviewsFragment f, @NonNull View layout, String eventId, @NonNull String screenType) {
        ReviewsRequest request = new ReviewsRequest(f, layout, eventId, screenType);
        request.start();
    }
}